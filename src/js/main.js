...
jQuery(document).ready(function() {
    ...
    jQuery('[data-whatever="@styleSelect"]').click(function() {
        ...
        //樣式選擇API導入 - [開始]
        jQuery.ajax({
            url: "https://testapi.ladraw.com:20102/Services/APIService.asmx/GetContactBackgroundTemplate",
            type: "POST",
            dataType: "JSON",
            ...
            '<div id="carouselExampleControls" class="carousel slide" data-ride="carousel" data-interval="1000">\
                <div class="carousel-inner" role="listbox" style=" height:480px; text-align:center; !important;">\
                    <div class="carousel-item active">\
                        <img src="http://ondinas.com.br/site/wp-content/themes/options/images/skins/headers/full_width/header-autumnBreeze.jpg" id="img1" class="center-block w-auto h-480" style="height:480px" alt="First slide">\
                    </div>\
                    <div class="carousel-item">\
                        <img src="http://www.boostnet.in/wp-content/uploads/2016/10/Header-1.png" id="img2" class="center-block w-auto h-480" style="height:480px" alt="Second slide">\
                    </div>\
                    <div class="carousel-item">\
                        <img src="https://steklin.ru/wp-content/uploads/2019/12/Header-PNG-Pic.png" id="img3" class="center-block w-auto h-480" style="height:480px" alt="Third slide">\
                    </div>\
                </div>\
            </div>';
